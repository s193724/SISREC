...
# --- Save matrix ---
save_npz("user_hotel_matrix_train.npz", user_item_matrix)
...
loaded = load_npz("user_hotel_matrix_train.npz")
assert (loaded != user_item_matrix).nnz == 0
print("Matrix saved and loaded successfully.")


# Filtered reviews: 17290
# Non-zero weighted scores: 17290
# User-item matrix shape: (62006, 3428)
# Number of users: 62006, number of hotels: 3428
# Non-zero elements in matrix: 17258
# Sparsity: 99.99%
# Matrix saved and loaded successfully.
#
# Process finished with exit code 0

# Filtered reviews: 69160
# Non-zero weighted scores: 69160
# User-item matrix shape: (62006, 3428)
# Number of users: 62006, number of hotels: 3428
# Non-zero elements in matrix: 68665
# Sparsity: 99.97%
# Matrix saved and loaded successfully.
#
# Process finished with exit code 0